...
export class HorizontalFireball extends Fireball {
    constructor(position) {
        super(position, new Vector(2, 0));
    }
}
export class VerticalFireball extends Fireball {
    constructor(position = new Vector(0, 2)) {
        super(position, new Vector(0, 2));
    }
}
export class FireRain extends Fireball {
    constructor(position = new Vector(0, 3)) {
